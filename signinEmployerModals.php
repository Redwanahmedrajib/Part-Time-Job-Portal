  ...
  <div class="tab-content">
      ...
      <form class="cd-form" method="post" action="registerEmployer.php" enctype="multipart/form-data">
            ...
            <label class="label-text">Company Name</label>
						...
						<input class="full-width has-padding has-border" id="name" name="name" type="text" placeholder="RFL,DATASOFT...">
					</p>
					<p class="fieldset">
            <label class="label-text">E-mail</label>
						<label class="image-replace cd-email" for="empsignup-email">E-mail</label>
            <input class="full-width has-padding has-border" id="email" name="email" type="email" placeholder="example@gmail.com">
					</p>
					<p class="fieldset">
            ...
            <label class="label-text">phone</label>
						<label class="image-replace cd-phone" for="empsignup-phone">phone</label>
            <input class="full-width has-padding has-border" id="phone" name="phone" type="phone" placeholder="019122344555">
					</p>
					<p class="fieldset">
            <label class="label-text">address</label>
						<label class="image-replace cd-address" for="empsignup-address">address</label>
            <input class="full-width has-padding has-border" id="address" name="address" type="address" placeholder="H#12,R#5,DIT Prjoect,Dhaka-1212">
					</p>
          <p class="fieldset">
    ...
    <div id="menu1" class="tab-pane fade"  style="width: 50%;">
      ...
      <form class="cd-form" method="post" action="registerJobseeker.php" enctype="multipart/form-data">
          ...
          <p class="fieldset">
            <label class="label-text">Upload Resume:</label>
