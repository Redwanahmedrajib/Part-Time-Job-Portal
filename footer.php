...
<footer id="contactus" style="background-color: #1f1f1f;"  >
	...
	<p style="color: aqua" class="footer-links">
            ...
            <h3 style="color: aqua"><a href="#"> Developed by <h3 style="font-family:audiowide;display:inline">Redwan</h3> </a></h3>
   ...
   <br>
    <div >
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> Dhaka </p>
      <p><span class="glyphicon glyphicon-phone"></span> +01921121311</p>
