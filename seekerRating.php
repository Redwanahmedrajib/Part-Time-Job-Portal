			...
			<div class="col-md-4"  style=" height: 50vh; margin-top:5% "> 
				<form action="" method="POST">
				  <div class="form-group">
				    <label for="exampleInputEmail1">Give Rating to Employer</label>
				    ...
				    <small id="emailHelp" class="form-text text-muted">Give Rating based on overall Employer behavior, payment....</small>
				  </div>
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO `employer_rating`(`eid`, `sid`,`pid`, `rating`) VALUES ('$eid','$sid','$pid','$rating');";
	include 'connect.php';
    if ($conn->query($sql) === TRUE) {
        echo '<script>alert("Rating Given.")</script>';
        echo '<script>window.location="Appliedjobs.php"</script>';
    } else {
